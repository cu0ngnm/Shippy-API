...
export default {
  ...
  createOrder: {
    body: {
      ...
      from_longitude: Joi.string().regex(/^[0-9]{5,15}$/).required(),
      from_latitude: Joi.string().regex(/^[0-9]{5,15}$/).required(),
      to_longitude: Joi.string().regex(/^[0-9]{5,15}$/).required(),
      to_latitude: Joi.string().regex(/^[0-9]{5,15}$/).required(),
