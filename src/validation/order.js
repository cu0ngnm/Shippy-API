...
export default {
  ...
  createOrder: {
    body: {
      ...
      from_longitude: Joi.string().regex(/^[0-9.]{4,100}$/).required(),
      from_latitude: Joi.string().regex(/^[0-9.]{4,100}$/).required(),
      to_longitude: Joi.string().regex(/^[0-9.]{4,100}$/).required(),
      to_latitude: Joi.string().regex(/^[0-9.]{4,100}$/).required(),
